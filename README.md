...
[![codecov](https://codecov.io/gh/scbrianti2022/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/scbrianti2022/fastapi)
[![CI](https://github.com/scbrianti2022/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/scbrianti2022/fastapi/actions/workflows/main.yml)

Awesome fastapi created by scbrianti2022

## Install

from source
```bash
git clone https://github.com/scbrianti2022/fastapi fastapi
cd fastapi
make install
```
